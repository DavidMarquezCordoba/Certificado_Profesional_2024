...
// Definición de array "modulos":

// const modulos = [{...}, {...}, {...}, {...}];:
// Se crea una constante llamada modulos que contiene un arreglo (array) de objetos. Cada objeto dentro del arreglo representa 
// un módulo de estudio.
// Propiedad "titulo":

// titulo: "Programación web en el entorno cliente...";
// Cada objeto tiene una propiedad titulo que es una cadena de texto que contiene el nombre o título del módulo.
// Propiedad "icono":

// icono: "<svg xmlns=\"http://www.w3.org/2000/svg\"...";
// La propiedad icono es una cadena que contiene un código SVG. Este SVG se representa en formato de texto y se usa para insertar 
// un icono gráfico en la interfaz de usuario.
// Las comillas dobles dentro de la cadena son escapadas con la barra invertida (\") para evitar errores en la interpretación del string.
// Propiedad "texto":

// texto: "ursus sed...";
// La propiedad texto es una cadena que contiene una breve descripción o introducción al contenido del módulo.
// Propiedad "horas":

// horas: 150;
// La propiedad horas es un número entero que representa la cantidad de horas dedicadas al módulo.
// Explicación general:
// Este código define un arreglo llamado modulos, que contiene una lista de objetos. Cada objeto representa un módulo de estudio, 
// con varias propiedades importantes:

// titulo: El nombre del módulo.
// icono: El código SVG del icono representativo del módulo.
// texto: Descripción del contenido o propósito del módulo.
// horas: Duración en horas de cada módulo.
// Cada objeto en el array sigue el mismo formato, pero con valores diferentes, lo que permite tener una lista dinámica de módulos 
// para una aplicación o página web. Los iconos en formato SVG pueden ser utilizados para ilustrar visualmente cada módulo, haciendo la interfaz más atractiva.



// para el icono usamos dobles comillas, pero tenemos que poner todo el SVG en la misma linea y escapar las dobles comillas del 
// interior con barra invertida \



// Creamos un array llamado "modulos" que contiene una lista de objetos
const modulos = [{
    // Título del módulo, que es una cadena de texto
    titulo:"Programación web en el entorno cliente Programación web en el entorno cliente",
    
    // Icono SVG representado en formato de cadena de texto. El código del SVG está escapado correctamente para evitar conflictos de comillas dentro de la cadena.
    ...
    // Descripción del módulo. Texto explicativo para dar más información sobre el contenido del curso.
    ...
    // Descripción detallada del tercer módulo
    ...
    // Duración del tercer módulo
    horas: 170,
}, {
    // Título del cuarto módulo
    titulo:"Módulo de prácticas profesionales",
    
    // Icono SVG del cuarto módulo
    icono: `<svg x-bind:width="size" x-bind:height="size" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="44" height="44">
    ...
    // Texto explicativo para el cuarto módulo
