...
<?php
    $modulosFormativos = json_decode(file_get_contents("json/modulos-formativos.json"), true);
?>
...
<main class="contenedor sombra para">
        ...
        <div class="modformativos">
            <?php 
                foreach($modulosFormativos as $modulos){?>
                    <section class="modformativo">
                        <h3><?php echo $modulos['titulo']?></h3>
                        <div class="icono">
                            <?php echo $modulos['icono']?>
                        </div>
                        <p><?php echo $modulos['texto']?></p>
                        <p class="horas">Horas: <?php echo $modulos['horas']?></p>
                    </section>
                <?php }
            ?>
        </div>
