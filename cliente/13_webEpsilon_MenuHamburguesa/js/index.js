// para el icono usamos dobles comillas, pero tenemos que poner todo el SVG en la misma linea y escapar las dobles comillas del interior con barra invertida \
const modulo0 = {
...
// para el icono usamos comillas simples, pero tenemos que poner todo el SVG en la misma linea
const modulo1 = {
...
// para el icono usamos comillas invertidas y así podemos usar el SVG con el contenido en diferentes lineas del código
const modulo2 = {
...
// conseguimos el elemento contenedor para insertar los elementos creados si usamos el método appendChild
const contenedor = document.querySelector(".modformativos");

// localizamos el moduloFormativo0 que nos servirá como base para clonar los otros 3 módulos formativos
const moduloFormativo0 = document.querySelector(".modformativo");
const CLONAR_CONTENIDO = true;   // Si fuera false no copiaria el contenido del elemento que vamos a clonar
...
// Cambiamos el contenido de los elementos clonados
